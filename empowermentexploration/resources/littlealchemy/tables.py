...
class Tables():
    ...
    def get_tables(self, table_type='combination', expand=False):
        ...
        # print info for user
        print('\nGet table of type {} for childrenalchemy.'.format(table_type))
        ...
        # write to JSON file
        with open('empowermentexploration/resources/littlealchemy/data/childrenalchemy{}Table.json'.format(table_type.capitalize()), 'w') as filehandle:
        ...
        # write to csv file
        table_csv.to_csv('empowermentexploration/resources/littlealchemy/data/childrenalchemy{}Table.csv'.format(table_type.capitalize()), index=False, float_format='%.f')

    def expand_combination_table(self, table_results):
        ...
        """
        # number of elements
        n_elements = 540 # original game tree contains 540 elements
