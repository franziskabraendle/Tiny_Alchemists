...
//if data should be saved in firebased uncomment this part
...
function experiment()
{
	if (current.includes("questionmark"))
	{
      ...
      collect=collect.concat([[englishElements[originalElements.indexOf(current[0])], englishElements[originalElements.indexOf(current[1])], englishElements[originalElements.indexOf(outcome)]]]);
		}
    else{
      collect=collect.concat([[englishElements[originalElements.indexOf(current[0])], englishElements[originalElements.indexOf(current[1])], "none"]]);
    }
...
function senddata() {
  ...
  for (var i=0; i<elements.length; i++)
	{
		translateelements[i]=englishElements[originalElements.indexOf(elements[i])];
	}
  //All data to save
  saveDataArray = {
    'collect': collect,
  ...
  saveText(JSON.stringify(saveDataArray), 'TinyAlchemyData.JSON');
}
